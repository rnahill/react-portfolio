...
<div className="row about-container d-flex align-items-center">
    <div className="col row">
        <h2 style={styles.aboutme} className="col">About me</h2>
        <img style={styles.img} src={placeholder} />
    </div>
    <p className="container border border-secondary shadow-lg p-3 m-5 rounded">
